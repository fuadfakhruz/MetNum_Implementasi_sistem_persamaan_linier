...
def lu_decomposition(matrix):
    #Melakukan dekomposisi LU pada matriks.
    size = len(matrix)
...
def solve_using_inverse(A, b):
    #Menyelesaikan sistem persamaan linear menggunakan matriks invers. 
    A_inv = matrix_inverse(A)
    x = matrix_multiply(A_inv, [b])[0]
    return x

def solve_using_lu(A, b):
    #Menyelesaikan sistem persamaan linear menggunakan dekomposisi LU.
...
def main():
    ...
    print("1. Gunakan Metode Matriks Balikan")
    print("2. Gunakan Metode Dekomposisi LU Gauss")
    print("3. Gunakan Metode Dekomposisi Crout")
